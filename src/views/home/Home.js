...
function mapActionToProps(dispatch) {
  return {
    ...
    cnodeAjax:(params)=>dispatch(cnode(params)) // 发送第一个action
  }
}
...
class Home extends React.Component {
  ...
  click() {
    ...
    console.log("滴滴1",this.props.cnodelist)
  }
  ...
  componentDidMount(){
    ...
    this.props.cnodeAjax(params)
  }
  createCnodeList(){
    console.log("this",this.props.cnodelist)
    if(this.props.cnodelist){
